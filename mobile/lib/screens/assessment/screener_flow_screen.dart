...
class _ScreenerFlowScreenState extends State<ScreenerFlowScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.screenerType.toLowerCase().contains('phq')) {
      _questions = [
  ...
  Future<void> _finishAssessment() async {
    ...
    final isPhq = widget.screenerType.toLowerCase().contains('phq');
    final maxScore = isPhq ? 27 : 21;
    ...
    final testName = isPhq ? 'PHQ-9 Depression Screener' : 'GAD-7 Anxiety Screener';
    final entry = {
      'testName': testName,
      'score': totalScore,
      'maxScore': maxScore,
