  ...
  Future<void> _callContact(Map<String, String> contact) async {
    ...
    if (cleanPhone.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Invalid phone number for this contact.'),
        ...
        builder: (context, setDialogState) => AlertDialog(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  ...
                  style: TextStyle(fontFamily: 'Inter', fontSize: 12, color: Color(0xFF64748B), height: 1.35),
                ),
                ...
                Wrap(
                  ...
                  children: presetRelations.map((tag) {
                    final isSelected = selectedRelation == tag;
                    return ChoiceChip(
                      label: Text(tag),
                      selected: isSelected,
          ...
          actions: [
            ...
            ElevatedButton.icon(
              onPressed: () async {
                ...
                if (mounted) {
                  ...
                  messenger.showSnackBar(
                    SnackBar(
                      content: Text('Saved $name to trusted contacts.'),
                      backgroundColor: const Color(0xFF059669),
                      behavior: SnackBarBehavior.floating,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                    ),
              ...
              label: const Text('Save Contact', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w600)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.contact_phone_outlined, size: 44, color: AppColors.primary),
                          ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Add Contact', style: TextStyle(fontFamily: 'Poppins', color: Colors.white, fontWeight: FontWeight.w700)),
      ),
    );
  }
}
