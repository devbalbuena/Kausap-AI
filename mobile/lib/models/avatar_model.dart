...
class AvatarData {
  static const List<AvatarModel> all = [
    ...
    AvatarModel(
      ...
      tier: 'basic',
      imagePath: 'assets/avatars/avatar_mascot_buddy.png',
    ...
    AvatarModel(
      ...
      tier: 'basic',
      imagePath: 'assets/avatars/avatar_doc_santos.png',
      systemPrompt: 'You are Doc Santos, a compassionate mental health guide and physician. Help students identify negative thinking patterns and practice calming thought-reframing techniques.',
